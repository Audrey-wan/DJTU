...
CREATE TABLE `t_product` (
  ...
  `fenleiid` varchar(20) DEFAULT NULL,
  `fname` varchar(20) DEFAULT NULL,
  `jiage` float DEFAULT NULL,
  `tuijian` varchar(20) DEFAULT NULL,
  `dianjishu` int(11) DEFAULT NULL,
  `xiaoliang` int(10) DEFAULT NULL,
  `miaoshu` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;
...
insert  into `t_user`(`id`,`username`,`password`,`xingming`,`role`,`dianhua`,`dizhi`) values (8,'111111','111111','张三',0,'13011111211','大连交通大学');
insert  into `t_user`(`id`,`username`,`password`,`xingming`,`role`,`dianhua`,`dizhi`) values (9,'222222','222222','李四',0,'13812121111','大连');
